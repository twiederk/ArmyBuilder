...
INSERT INTO army_single_model (id, profile_id, name, army_main_model_id, description, standard_bearer, musician, movement_type_id, mount) VALUES (1, 11506, 'General', 1, '', 0, 0, 0, 0);
INSERT INTO army_single_model (id, profile_id, name, army_main_model_id, description, standard_bearer, musician, movement_type_id, mount) VALUES (2, 11906, 'Speerträger', 2, '', 0, 0, 0, 0);
INSERT INTO army_single_model (id, profile_id, name, army_main_model_id, description, standard_bearer, musician, movement_type_id, mount) VALUES (3, 12159, 'Streitwagen', 3, '', 0, 0, 0, 0);
INSERT INTO army_single_model (id, profile_id, name, army_main_model_id, description, standard_bearer, musician, movement_type_id, mount) VALUES (4, 11906, 'Streitwagenlenker', 3, '', 0, 0, 0, 0);
INSERT INTO army_single_model (id, profile_id, name, army_main_model_id, description, standard_bearer, musician, movement_type_id, mount) VALUES (5, 12034, 'Elfenroß', 3, '', 0, 0, 0, 0);
